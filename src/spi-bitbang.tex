...
Assume the header shown in Snippet \ref{code:bit-bang-header} is available for use in the bit-banging implementation of SPI. The transceive function should use CPOL = 1, CPHA = 1. 
...
\noindent Snippet \ref{code:bit-bang-spi} shows a basic implementation of a bit-banged SPI master transceive.
