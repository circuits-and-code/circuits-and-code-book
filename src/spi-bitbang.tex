...
\lstinputlisting[caption={Bit Bang HAL Header}, label={code:bit-bang-header}]{bitbang_spi/bitbang_spi_header.h}
...
\lstinputlisting[caption={Bit Bang SPI Implementation}, label={code:bit-bang-spi}]{bitbang_spi/bitbang_spi.c}
