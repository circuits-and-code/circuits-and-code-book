...
\lstset{style=modernC} % Set the style
...
% \date{} % By leaving this blank it defaults to the build date, it's nice to leave it like this for now because I'm curious when we last updated the teaser. I know I fixed the LED question a lot after we initially released the teaser lol. 
