...
% Preamble
\renewcommand{\thesection}{\Roman{section}} % roman numerals for preamble.tex only
\subfile{preamble.tex}
\newpage
\renewcommand{\thesection}{\arabic{section}} % Reset to Arabic numerals for the remainning sections
\setcounter{section}{0} % Reset section numbering after preamble

% Questions: one .tex per question
% first edition is twenty questions, roughly three pages of solution each and one page for the question
