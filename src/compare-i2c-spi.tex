...
% @sahil thoughts on including numbers for how fast SPI commonly is to help build intuition for ppl?
...
\begin{itemize}
    ...
    %@daniel i saw on gdcos u wanted to add digital/vs analog stuff, think that can probs go here tho gonna leave that to u
\end{itemize}
