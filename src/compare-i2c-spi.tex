...
% TODO : @sahil words MISO and MOSI are used in footnote before it's explained what they stand for, need to fix.
% TODO : @sahil u say spi is devved by motorolla, can we say i2c is devved by nxp? that's true eh?
...
% TODO : @sahil state that each slave requires it's own CS line? guess diagram shows it but maybe explain it
