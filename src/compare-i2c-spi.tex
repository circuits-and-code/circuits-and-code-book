...
% @sahil should we add information about pull-up resistor value selection here ? 
...
\begin{itemize}
    ...
    % @sahil can you add a common speed for SPI, maybe say like 24 MHz or 60 MHz ? I literally got asked this in an interview today :d, hmm im also adding common operating freqs to signalling.tex
