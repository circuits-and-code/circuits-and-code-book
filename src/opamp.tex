...
% DRAW : op-amp with terminals labelled
...
% the text interleaved with math is quite hard to read, consider a better approach
...
% consider speacil case of resistors that simplifies things into the other cases above
% consider only doing diff amp circuit then discussing the special cases? Could make it even simpler and only do 
