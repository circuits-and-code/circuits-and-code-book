...
% TODO APPENDIX : move extra op-amp circuits to the appendix so people can solve them if they want to. idk maybe it's not worth putting into the appendix like it did take a bit to draw these but fuck it like who cares :d im learning how to write well.
% \begin{figure}[H]
%     \begin{center}
...
% TODO APPENDIX :  use appendix if I want to do extra proofs and stuff 
