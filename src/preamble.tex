...
% mention about how it's still useful for upper years to brush up on skills? -daniel
...
% From Daniel to Sahil: Is there something to be said for like "if you have no idea how to even start the question then skip to answer and/or attempt to cheat via using the internet or textbooks and see what u come up with?  @sahil->daniel yep
