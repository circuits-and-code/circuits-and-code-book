...
We'd like to thank the several individuals for taking the time to review and provide feedback on this guide. Their names can be found in the book's website \bluehref{https://circuits-and-code.github.io/acknowledgements/}{acknowledgements page} Feel free to reach out to us with feedback as we are looking to improve the guide over time. A full list of acknowledgements can be found on the book's website.
