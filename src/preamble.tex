...
\subsubsection{LaTeX}
This guide was written using Latex and the source code can be found at \bluehref{https://github.com/circuits-and-code/circuits-and-code-book/tree/main}{Circuits and Code Book GitHub}. This shows the code we used to generate plots, draw circuits, and create diagrams as well as comments containing more pilosophical thoughts for those interested in peering behind the curtain.
