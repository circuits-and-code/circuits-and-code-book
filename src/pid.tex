...
\lstinputlisting[caption={PID Control Structure}, label={code:pid}]{pid/pid_typedef.h}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{generated_images/pid_discretization.png}
...
\lstinputlisting[caption={PID Controller Step}, label={code:pid_controller}]{pid/pid_controller.c}
