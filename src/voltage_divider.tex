...
\begin{itemize}
    ...
    \item Why does reducing $R_{sum} = R_t + R_b$ reduce the impact of input bias current on a voltage divider circuit as shown in Figure \ref{voltage_divider_loaded}? % Algebraic proof as I showed in my commented formulas, this is a bit complex in my opinion so a fun follow-up
\end{itemize}
