...
\begin{figure}[H]
    \begin{center}
        ...
        \end{circuitikz}
        % TODO FORMATTING : remove weird space after figure before next section, idk how to do this correctly, need to figure it out eventually to save space on the page. Alternatively could put voltage divider off to the side of text. 
        % Do not rotate voltage divider, resistors are vertical deliberately for common drawing method.
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{circuitikz}
        % TODO FORMATTING : remove extra space after figure
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{circuitikz}
        % TODO FORMATTING : remove weird space after figure, idk how to do this correctly, need to figure it out eventually to save space on the page.
...
% TODO APPENDIX : Consider moving to appendix? 
% Moved to be a follow-up question instead for now, but could be appendixed in the future. This is a really important concept for low power systems but not going to worry about it for now due to it's complexity.
...
\begin{itemize}
    \item Reducing the quiescent current of a voltage divider can be done by increasing $R_{sum}$, however, this only gets you so far. Propose a simple circuit to disable current consumption when the voltage divider is not needed. % \ref{fig:voltage_divider_switched}
