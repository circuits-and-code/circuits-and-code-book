...
% from @sahil -> given the page count is chilling on pin overvoltage, I would suggest that you put something in the beginning to put "pin overvoltage" in scope of the question to then make this section connect with the question  
% TODO WRITE : @daniel
