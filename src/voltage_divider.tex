...
\begin{figure}[H]
    \begin{center}
        ...
        \end{circuitikz}
        % TODO : remove weird space after figure before next section, idk how to do this correctly, need to figure it out eventually to save space on the page. Alternatively could put voltage divider off to the side of text. 
...
% TODO : Consider moving to appendix? 
