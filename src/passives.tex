...
% TODO : remember to use noindent for all paragraphs. finish other TODOs first because the figures break it up. 
...
% Philosophy if we include a lot of circuits in this question: I wanna give the full answer to simple circuits (like this RC low pass) and then kinda skip to solution for more complex ones assuming readers will be primed to acquire knowledge if they are so inclined. 
...
% if I keep this analysis frequency then do a freq domain plot of this circuit in log log scale 
...
% TODO solve using frequency domain ? 
