...
\noindent State any assumptions regarding component values. Assume that there is no load on the output of the circuits.
...
\subsection{Circuit C: RC Low Pass Filter} % @daniel when I read this it felt pretty overwhemling and hard to follow (partially cause it's very interleaved with math and text). I would suggest breaking up the math into smaller paragraphs, and choosing one analysis method (personally, the complex impedance method is the most intuitive for me since it turns into a voltage divider, which is content we've already introduced). Also remember to use \noindent lol
...
% I would perhaps make this a little more concise and not delve into I2C specifically - feels like everything below is scope creep for the question getting into I2C imo, though I do agree it would be good to impart the fundamentality to the reader. 
