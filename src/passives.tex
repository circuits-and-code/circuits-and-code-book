...
% @daniel can I suggest moving the passive definitions to the appendix and providing a link here for the component relationships? We're already at 6 pages for this question :Sob:
\subsection{Passives}
...
% @daniel i gave u a 'freq response' plot for the high pass fitler if u want. i personally think this should be out of scope, but i can see a rationale for including it.
% \begin{figure}[H]
%     \centering
