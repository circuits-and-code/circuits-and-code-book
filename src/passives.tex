...
\end{figure}
% It may be nice to give the readers a frequency domain bode plot of the RC circuit as well. That question is sometimes asked, however, that is a bit of scope creep. 
