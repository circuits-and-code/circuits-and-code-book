...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{generated_images/priority_inversion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{generated_images/priority_inheritance.png}
