...
% TODO WRITE : @sahil "control the average voltage" is maybe a bit deceptive way of phrasing it, technically accurate im just no a big fan. Can you fix or add a comment explainning here?
