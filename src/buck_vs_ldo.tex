...
\begin{figure}[H]
    \begin{center}
        \begin{circuitikz}
            ...
            \draw (0.5, 4) to[switch] (2, 4); % TODO FORMATTING : figure out how to make switch bigger so it looks better, for some reason using scale breaks it ... 
        ...
        \end{circuitikz}
    \end{center}
    % TODO FORMATTING : it adds a very large new line after the figure, figure out how to fix this
...
% TODO FORMATTING: place both buck converter drawings side by side?
\begin{figure}[H]
    \begin{center}
        \begin{circuitikz}
            \draw (0, 4) node[anchor=east] {$V_{in}$} -- (0.5, 4);
...
% TODO FORMATTING: ensure used noindent for all paragraphs. finish other TODOs first because the figures break it up nicely sometimes. 
