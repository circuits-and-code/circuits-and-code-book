...
Selection of switching frequency is critical in the design of a buck converter. Increasing switching frequency increases switching losses in the converter, but allows the usage of lower inductance inductors which are usually cheaper and come in smaller packages.\footnote{The inductor is often the largest single component in a buck converter so increasing switching frequency to reduce buck converter overall circuit board area is a common practice.} Switching frequencies of modern buck converters range from roughly 100 kHz to 5 MHz. 
