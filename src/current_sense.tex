...
% Resistive Current Sense Amplifiers
...
% INA180, INA240
% INA226 I2C enabled option 

% layout example: kelvin sense ?? maybe not, too far, never asked, but could be a nice addition to this 
