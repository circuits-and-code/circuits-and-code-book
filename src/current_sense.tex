...
% Not including a picture of a current clamp because it's not really necessary for the interview question/solution/understanding. Your ability to explain it is more important than knowing what it looks like imo. If we have to include one then I guess https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Clampmeter_Fluke_337.jpg/300px-Clampmeter_Fluke_337.jpg works. 

\subsection{Follow-ups}
\begin{itemize}
    \item What is kelvin sense? 
    \item What are four-wire digital multi-meter probes and why would you use them?
    \item What is a hall effect sensor? When would one be used?
