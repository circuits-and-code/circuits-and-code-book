...
Figure \ref{fig:high_side_current_sense} shows a high side current sensing circuit, however, 'low side' current sensing is also possible, as shown in Figure \ref{fig:low_side_current_sense}.
