...
% TODO : either change the drawing to be more realistic or add a footnote saying the untriggerred waveform changes based on scope settings and the capture shown here is just an example. 
% lemme know if u have any thoughts @sahil
\begin{figure}[H]
    \centering
