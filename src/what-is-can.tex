...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/diff_digital_signal.png} % @sahil binary output logic appears inverted, i believe this is incorrect, like you should switch the polarity so that it aligns with CAN dominant being logic 0. 
...
Another advantage of this configuration is immunity to small common mode offsets.
