...
\newnoindentpara The unit tests work by comparing the expected output (the extracted values and the return value of the parsing function) with the actual results. Snippet \ref{code:parsing_test_function} shows example unit tests and a crude test framework for testing the packet parsing function.
